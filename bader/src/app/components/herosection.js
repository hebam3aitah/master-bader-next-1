      ...
      >
        ...
        <div className="relative z-10 max-w-4xl ml-auto px-10 lg:px-20 text-right">
          <p className="text-3xl md:text-4xl max-w-[500px] mb-[40px] font-bold">
            بادر هي مبادرة مجتمعية تهدف إلى تحسين أحياءنا وجعلها مكانًا أفضل للجميع.
            <br />
            شاركنا التغيير وصنع القرار.
          </p>
          <p className="mt-4 text-md max-w-[500px] text-white">
            في "بادر"، معًا نُعيد الحياة لأحيائنا. شاركنا التغيير وصنع الفرق!
            <br />
            تطوع الآن.
          </p>

          {/* CTA Button */}
          <Link href="/Donations" className="inline-block mt-[30px] relative group">
